...
//  WatchChainIOS
//
//  Created by Alexej K on 19.01.23.
//
...
extension AlertManager {
    ...
    public static func showRegisterationErrorAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Unknown Registration Error", message: nil)
    }
    
    public static func showRegisterationErrorAlert(on vc: UIViewController, with error: Error) {
